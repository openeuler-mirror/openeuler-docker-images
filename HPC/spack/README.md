...
|------|-----------|---------------|
|[1.2.2-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/HPC/spack/1.2.2/24.03-lts-sp4/Dockerfile) | spack 1.2.2 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
