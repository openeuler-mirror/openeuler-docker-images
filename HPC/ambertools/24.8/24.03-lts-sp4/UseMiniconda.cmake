...
function(download_and_use_miniconda)
    ...
    message(STATUS "Downloading Python 3 Miniforge")
        ...
        execute_process(COMMAND ${CONDA} install -y -q conda-build numpy scipy cython ipython notebook pytest mock
...
function(install_miniconda)
    ...
    if((HOST_OSX OR HOST_LINUX) AND (TARGET_OSX OR TARGET_LINUX))
        ...
        # some users don't get a proper pdb2pqr, to allow a good symlink
