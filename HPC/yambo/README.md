...
|----------|-------------|------------------|
|[5.3.0-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/HPC/yambo/5.3.0/24.03-lts-sp4/Dockerfile) | yambo 5.3.0 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
