...
|------|-----------|---------------|
|[2.7.2-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/HPC/wannier_tools/2.7.2/24.03-lts-sp4/Dockerfile) | wannier_tools 2.7.2 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
...
```docker pull openeuler/wannier_tools:{Tag}```
- Run the Docker container to launch the WannierTools environment:
```docker run -it openeuler/wannier_tools:{Tag}```
