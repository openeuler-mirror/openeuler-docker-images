...
Learn more at [kb_python](https://github.com/pachterlab/kb_python).
...
```docker pull openeuler/kb_python:{Tag}```
- Run the Docker container to launch the kb_python environment.
```docker run -it openeuler/kb_python:{Tag}```
