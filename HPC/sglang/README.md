...
|------|-----------|---------------|
|[0.5.11-24.03-lts-sp3](https://gitee.com/openeuler/openeuler-docker-images/blob/master/HPC/sglang/0.5.11/24.03-lts-sp3/Dockerfile)| sglang 0.5.11 on openEuler 24.03-lts-sp3 | amd64, arm64 |
