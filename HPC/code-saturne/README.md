...
- Obtain the code_saturne docker image from DockerHub:
```docker pull openeuler/code-saturne:{Tag}```
- Run the Docker container to launch the code_saturne environment.
```docker run -it openeuler/code-saturne:{Tag}```
