...
|------|-----------|---------------|
|[5.5.1-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/HPC/seurat/5.5.1/24.03-lts-sp4/Dockerfile) | seurat 5.5.1 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
