...
|------|-----------|---------------|
|[4.47-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/HPC/copasi/4.47/24.03-lts-sp4/Dockerfile) | copasi 4.47 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
