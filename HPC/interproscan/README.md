...
2. Obtain the InterProScan docker image (choose one):
- Pull the pre-built Docker image from DockerHub
  - ```docker pull openeuler/interproscan:5.77-108.0-oe2403sp3```
- Or build the image locally from source
  - ```docker build -t openeuler/interproscan:5.77-108.0-oe2403sp3 5.77-108.0/24.03-lts-sp3/```
3. Run the Docker container to launch the InterProScan environment.
- ```docker run -it openeuler/interproscan:5.77-108.0-oe2403sp3```
