...
|------|-----------|---------------|
|[9.8.0-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/HPC/dealii/9.8.0/24.03-lts-sp4/Dockerfile) | dealii 9.8.0 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
