...
def generate_summary(input_json, output_file):
    ...
    if summary:
        ...
        if "min_time_s" in summary:
            lines.append(f"    Min operation time: {summary['min_time_s']}s")
        if "max_time_s" in summary:
            lines.append(f"    Max operation time: {summary['max_time_s']}s")
        lines.append("")
