...
|----------|-------------|------------------|
|[10.0.12-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Others/dotnet-aspnet/10.0.12/24.03-lts-sp4/Dockerfile) | dotnet 10.0.12 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
