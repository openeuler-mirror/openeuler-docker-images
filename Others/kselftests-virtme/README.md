...
|----------|-------------|------------------|
|[1.27-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Others/kselftests-virtme/1.27/24.03-lts-sp4/Dockerfile)| Virtme-ng 1.27 on openEuler 22.03-LTS-sp4 | amd64, arm64 |
