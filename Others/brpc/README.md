...
2. Obtain the brpc docker image (choose one):
- Pull the pre-built Docker image from DockerHub
  - ```docker pull openeuler/brpc:1.16.0-oe2403sp3```
- Or build the image locally from source
  - ```docker build -t openeuler/brpc:1.16.0-oe2403sp3 1.16.0/24.03-lts-sp3/```
3. Run the Docker container to launch the brpc developer environment.
- ```docker run -it openeuler/brpc:1.16.0-oe2403sp3```
