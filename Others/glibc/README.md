...
|----------|-------------|------------------|
|[2.42-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Others/glibc/2.42/24.03-lts-sp4/Dockerfile) | glibc 2.42 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
