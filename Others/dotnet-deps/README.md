...
|----------|-------------|------------------|
|[8.0-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Others/dotnet-deps/8.0/24.03-lts-sp4/Dockerfile)| It includes the runtime dependencies required to run a standard self-contained .NET application of version 8.0.x on openEuler 22.03-LTS-SP4 | amd64, arm64 |
