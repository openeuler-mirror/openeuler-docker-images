...
2. Obtain the hdWGCNA docker image (choose one):
- Pull the pre-built Docker image from DockerHub
  - ```docker pull openeuler/hdwgcna:0.4.09-oe2403sp3```
- Or build the image locally from source
  - ```docker build -t openeuler/hdwgcna:0.4.09-oe2403sp3 0.4.09/24.03-lts-sp3/```
3. Run the Docker container to launch the hdWGCNA environment.
- ```docker run -it openeuler/hdwgcna:0.4.09-oe2403sp3```
