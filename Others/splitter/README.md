...
|----------|-------------|------------------|
|[1.0.3-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Others/splitter/1.0.3/24.03-lts-sp4/Dockerfile)| Splitter 1.0.3 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
