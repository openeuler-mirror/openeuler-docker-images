...
|----------|-------------|------------------|
|[3.6.4-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Cloud/loki/3.6.4/24.03-lts-sp4/Dockerfile) | loki 3.6.4 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
