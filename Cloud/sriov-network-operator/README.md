...
|-----|-----------|---------------|
| [1.6.0-oe2403sp4](https://atomgit.com/openeuler/openeuler-docker-images/blob/master/Cloud/sriov-network-operator/1.6.0/24.03-lts-sp4/Dockerfile) | SR-IOV Network Operator 1.6.0 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
