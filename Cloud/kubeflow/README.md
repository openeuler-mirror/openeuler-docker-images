...
|-----|-----------|---------------|
| [1.10.0-oe2403sp3](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Cloud/kubeflow/1.10.0/24.03-lts-sp3/Dockerfile) | Kubeflow 1.10.0 on openEuler 24.03-LTS-SP3 | amd64, arm64 |
