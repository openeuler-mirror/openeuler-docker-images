...
|----------|-------------|------------------|
|[1.31.1.1-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Cloud/openresty/1.31.1.1/24.03-lts-sp4/Dockerfile) | openresty 1.31.1.1 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
