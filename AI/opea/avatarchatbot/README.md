...
The tag of each AvatarChatbot docker image is consist of the version of AvatarChatbot and the version of basic image. The details are as follows

| Tags | Currently |  Architectures|
|--|--|--|
|[1.2-oe2403lts](https://gitee.com/openeuler/openeuler-docker-images/blob/master/AI/opea/avatarchatbot/1.2/24.03-lts/Dockerfile)| AvatarChatbot 1.2 on openEuler 24.03-LTS | amd64 |
...
3. Consume the AvatarChatbot Service.
...
3. Set up other environment variables:
   ...
   > Get `set_env.sh` here: [set_env.sh](https://gitee.com/openeuler/openeuler-docker-images/tree/master/AI/opea/avatarchatbot/doc/set_env.sh)
...
> Get `compose.yml` here: [compose.yml](https://gitee.com/openeuler/openeuler-docker-images/tree/master/AI/opea/avatarchatbot/doc/compose.yml)
...
```bash
docker pull openeuler/avatarchatbot:latest
```
