...
|----------|-------------|------------------|
|[22.0.0-oe2403sp4](https://gitee.com/openeuler/openeuler-docker-images/blob/master/Storage/arrow/22.0.0/24.03-lts-sp4/Dockerfile) | arrow 22.0.0 on openEuler 24.03-LTS-SP4 | amd64, arm64 |
